...
public class EyeTrackingManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 2. Safety Check: If gazes is null or empty, stop here to avoid the crash
        if (gazes == null || gazes.Length < 2)
        {
            return;
        }

        // 3. Assign data safely
        ...
        // 4. Check if your Inspector transforms are assigned
        if (gazeOriginTrans != null && originXRRig != null)
        {
